...
<div className="mt-4 lib-overview-steps">
  <style>{`
    ...
    <Step>
      <div className="flex items-center gap-4">
        ...
        <div className="space-y-2">
          ...
          <span className="block text-sm leading-6 text-fd-muted-foreground">
...
<Cards className="mt-4">
  <Card title="Mission-first motion" icon={<Rocket className="text-red-500" />}>
    <span className="block leading-6 text-fd-muted-foreground">
